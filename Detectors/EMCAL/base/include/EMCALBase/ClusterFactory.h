 ...
 public:
  ...
  class ClusterIterator
  {
   public:
    ...
    ClusterIterator(const ClusterIterator& other) = default;

    /// \brief Assignment operator
    /// \param other Reference for assignment
    /// \return Iterator after assignment
    ClusterIterator& operator=(const ClusterIterator& other) = default;
  ...
  int getSuperModuleNumber(void) const { return mSuperModuleNumber; }
  ...
  bool sharedCluster(void) const { return mSharedCluster; }
  ...
  bool getCoreRadius(void) const { return mCoreRadius; }
