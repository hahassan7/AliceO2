...
#include "Rtypes.h"  // for FEEDigitizer::Class, Double_t, ClassDef, etc
...
class FEEDigitizer : public TObject
{
 public:
  FEEDigitizer() = default;
  ~FEEDigitizer() override = default;
  FEEDigitizer(const FEEDigitizer&) = delete;
  FEEDigitizer& operator=(const FEEDigitizer&) = delete;
 ...
 private:
  ...
  bool mEmpty = true;                      ///< FEEDigitizer contains no digits/labels
  ...
  ClassDefOverride(FEEDigitizer, 1);
};
} // namespace emcal
} // namespace o2
